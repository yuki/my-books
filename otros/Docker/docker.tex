...
\infobox{\textbf{Una imagen contiene el servicio que nos interesa ejecutar junto con sus dependencias, y son independientes del servidor donde se ejecuta.}}
...
Para ello, podemos editar el fichero \configfile{/etc/group}, y añadir el usuario al grupo, o mejor, ejecutar estos comandos que ponemos a continuación:
