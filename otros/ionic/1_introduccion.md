...
- **Multiplataforma**: una sola base de código para Android, iOS y web (PWA).
...
- **Componentes UI**: elementos visuales (botones, listas, formularios).
- **Páginas**: vistas que representan pantallas de la app.
...
- [-p 8100:8100]{.verbatim}: por defecto es el puerto que se usa al realizar aplicaciones web.
