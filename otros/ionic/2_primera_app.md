...
Anteriormente se ha definido cómo desarrollar en un contenedor Docker, por lo que es imprescindible asegurar que lo hemos creado.
...
- **Tipo de componentes**: al elegir Angular, nos pregunta si queremos crear componentes **Standalone** o de tipo NgModules. Elegiremos **Standalone**, ya que nos va a permitir crear componentes que podremos utilizar en otros proyectos de manera más sencilla.

Una vez terminado el asistente nos creará un directorio con el nombre elegido, dentro de éñ el esqueleto del proyecto, instalará las dependencias necesarias y nos creará un proyecto GIT para poder subirlo a nuestro repositorio central.
