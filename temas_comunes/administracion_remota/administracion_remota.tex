...
Para ello es imprescindible conocer previamente la contraseña del usuario en el servidor. Este comando realizará una conexión SSH y copiará la \textbf{clave pública} en el fichero \configfile{~/.ssh/authorized_keys} del usuario en el servidor remoto. Este paso se puede realizar a mano (con un editor de texto).
