...
Aparte de estar creados en la ruta especificada, también deben de estar configurados dentro del fichero \configfile{app/Http/kernel.php}, donde ya están configurados para su apartado correspondiente, y donde se han creado unos \textit{alias} que hacen referencia a ellos.
