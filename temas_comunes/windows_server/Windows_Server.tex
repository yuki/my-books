...

{
    ...
    \begin{minipage}{0.36\linewidth}
            \vspace{-11pt}
            \includegraphics[width=\linewidth]{1_instalacion.png}
    \end{minipage}
}
...
\begin{center}
    \vspace{-10pt}
    \includegraphics[width=10cm]{2_instalacion.png}
    \vspace{-20pt}
\end{center}
...
\begin{center}
    \vspace{-10pt}
    \includegraphics[width=10cm]{3_instalacion.png}
    \vspace{-10pt}
\end{center}
...
\warnbox{\textbf{Es importante leer qué nos indica cada paso durante la instalación}}
...

{
    ...
    \begin{minipage}{0.36\linewidth}
        \vspace{-11pt}
        \includegraphics[width=\linewidth]{4_instalacion.png}
    \end{minipage}
}
...
\begin{wrapfigure}{r}{0.36\linewidth}
    \centering
    \vspace{-20pt}
    \includegraphics[width=\linewidth]{5_instalacion.png}
\end{wrapfigure}
...
\begin{center}
    \includegraphics[width=\linewidth]{gpo_1_1.png}
\end{center}
...

{
    ...
    \hfill
    \begin{minipage}{0.37\linewidth}
        \includegraphics[frame,width=\linewidth]{gpo_1_3.png}
    \end{minipage}
}
...
\begin{enumerate}
    ...
    \infobox{\textbf{Por defecto sólo los usuarios administradores pueden realizar conexiones de acceso remoto.}}
...
\warnbox{\textbf{Recuerda que para que funcione tienes que forzar que se actualice la GPO de manera remota o con “gpupdate.exe”.}}
...
\begin{center}
    \vspace{-10pt}
    \includegraphics[width=10cm]{sysprep_1.png}
    \vspace{-20pt}
\end{center}

Es por eso que Microsoft incorpora la aplicación \textbf{Sysprep}, que \textbf{se encarga } de eliminar esa información específica. Se encuentra en la ruta \commandbox{%WINDIR%\system32\sysprep\sysprep.exe} y puede ser ejecutado tanto en consola como en entorno gráfico.

Las funciones principales que nos permite Sysprep son:

\begin{itemize}
    \item Borra la información específica del PC de la imagen de Windows, incluyendo el SID. Esto permite crear imágenes que pueden ser aplicadas a otros equipos.
    \item Desinstala (pero sin borrar) drivers específicos del equipo.
    \item Prepara el PC para ser arrancado en modo \textbf{OOBE} (\textit{Out-of-Box Experience}). Este sistema deja el equipo con la instalación preparada como si un usuario arrancase por primera vez.
    \item Permite configuración “desatendida”, añadiendo un fichero con las respuestas de configuración.
\end{itemize}
...
\begin{center}
    \vspace{-10pt}
    \includegraphics[width=6cm]{sysprep_2.png}
    \vspace{-20pt}
\end{center}

Tal como se puede ver, \textbf{Sysprep} nos ofrece una serie de opciones que podemos elegir en su ejecución:

\begin{itemize}
    \item \textbf{Acción de limpieza del sistema}:
    \begin{itemize}
        \item \textbf{Iniciar la configuración OOBE}. Comentada previamente.
        \item \textbf{Iniciar modo auditoria del sistema}. El sistema auditoría permite saltarse el OOBE para entrar con permisos de Administrador para realizar configuraciones e instalaciones en la imagen. \href{https://docs.microsoft.com/en-us/windows-hardware/manufacture/desktop/audit-mode-overview?view=windows-10}{Más información}
        \item \textbf{Generalizar}: Esta es la opción que elimina la información específica del equipo.
    \end{itemize}

    \infobox{Si queremos crear una imagen o usar una máquina clonada tenemos que usar la opción \textbf{generalizar}}

    \item \textbf{Opciones de apagado}: Qué hacer una vez ejecutado Sysprep.
\end{itemize}
