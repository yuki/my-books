...
\begin{tcolorbox}[title=Creando usuarios en Active Directory]
    \centering
    \includegraphics[width=13cm]{gpo_1_1.png}
\end{tcolorbox}
...
\begin{tcolorbox}[title=Compartir una carpeta]
    \centering
    \includegraphics[width=13cm]{gpo_1_2.png}
\end{tcolorbox}
...

{
    \begin{minipage}{0.46\linewidth}
        \includegraphics[width=\linewidth]{gpo_1_5.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.46\linewidth}
...
\begin{center}
    \includegraphics[width=6cm]{gpo_1_7.png}
\end{center}
...
\begin{center}
    \includegraphics[trim={1 0 0 0},clip,width=14cm]{gpo_1_8.png}
\end{center}