...
Los márgenes son el espacio **exterior** que existe alrededor de un elemento. Permiten separar unos elementos de otros y son una de las partes fundamentales del **modelo de caja (*[box model](https://developer.mozilla.org/en-US/docs/Web/CSS/Guides/Box_model)*)**. Es importante no confundirlos con el [padding]{.verbatim} que veremos después, pero adelantamos ahora:

- **Margin** → espacio exterior.
- **Padding** → espacio interior.


Todo elemento HTML puede representarse mediante el siguiente modelo de caja:
...
Tal como se puede ver, el margen es el espacio que hay después del borde. 
