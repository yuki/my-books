echo [Enpresa kudeaketako sistemak]{.part}
cat ../sistemas_gestion_empresarial/1_introduccion_eus.md

echo [ERP]{.part}
cat ../sistemas_gestion_empresarial/2_erp_eus.md

echo [CRM]{.part}
cat ../sistemas_gestion_empresarial/3_crm_eus.md

echo [Odoo]{.part}
cat ../sistemas_gestion_empresarial/2_odoo_eus.md

echo [Datuen erabilera txostenetan]{.part}
cat ../../../anexos/datastudio/datastudio_eus.md
