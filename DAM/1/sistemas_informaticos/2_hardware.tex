...
%    Existen distintas maneras de interconexión:
%\begin{itemize}
%    \item \textbf{PGA}: De \textit{ping grid array}, o matriz de rejilla de pines. El procesador cuenta unos pines en formato perpendicular que se conectan al socket donde estarán unos agujeros. Los procesadores AMD Ryzen actuales usan esta tecnología.
%
