...
Cuando combinamos con otros sistemas de numeración, debemos indicar la base en la forma $ 9_{(10} $ , es decir, poniendo un pequeño “\textbf{(10}” a la derecha del número representado la base 10.
