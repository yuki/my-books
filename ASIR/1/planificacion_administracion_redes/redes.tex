...
\begin{itemize}
    ...
    \item Por la direccionalidad de los datos.
    \item Por el alcance.
...
Más adelante veremos distintos \hyperlink{sistemas_transmision}{sistemas de transmisión}, pero para ir diferenciando las redes podemos crear dos grandes grupos teniendo en cuenta el medio utilizado:
...
Del inglés \textit{Wide Area Network}, es una red que abarca grandes extensiones geográficas.
